...
exports.TIMOUT_SEC = exports.RES_PER_PAGE = exports.API_URL = void 0;
var API_URL = exports.API_URL = "https://forkify-api.herokuapp.com/api/v2/recipes/";
var TIMOUT_SEC = exports.TIMOUT_SEC = 10;
var RES_PER_PAGE = exports.RES_PER_PAGE = 13;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return Promise.race([fetchPromise, timeout(_config.TIMOUT_SEC)]);
        case 4:
          res = _context.sent;
          _context.next = 7;
          return res.json();
...
},{"regenerator-runtime":"node_modules/regenerator-runtime/runtime.js","../config.js":"src/js/config.js"}],"src/js/views/view.js":[function(require,module,exports) {
"use strict";
...
function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : String(i); }
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); } // import Fraction from 'fractional';
var RecipeView = /*#__PURE__*/function (_View) {
  ...
  function RecipeView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_errorMessage", 'we could not find that recipe.please try anoter one !');
...
},{"regenerator-runtime":"node_modules/regenerator-runtime/runtime.js","./config":"src/js/config.js","./views/helpers":"src/js/views/helpers.js","./views/recipeView":"src/js/views/recipeView.js"}],"src/js/views/searchView.js":[function(require,module,exports) {
"use strict";
...
var controlPagination = function controlPagination(goToPage) {
  _resultView.default.render(model.getSearchResultsPage(goToPage));
  _paginationView.default.render(model.state.search);
};
...
init();
},{"./model.js":"src/js/model.js","regenerator-runtime":"node_modules/regenerator-runtime/runtime.js","./views/recipeView.js":"src/js/views/recipeView.js","./views/searchView.js":"src/js/views/searchView.js","./views/resultView.js":"src/js/views/resultView.js","./views/paginationView.js":"src/js/views/paginationView.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
